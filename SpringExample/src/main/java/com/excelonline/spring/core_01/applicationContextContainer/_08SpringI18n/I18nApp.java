package com.excelonline.spring.core_01.applicationContextContainer._08SpringI18n;
...
public class I18nApp {
	public static void main(String args[])throws Exception {
		...
		ClassPathXmlApplicationContext  ctx = new ClassPathXmlApplicationContext("com/excelonline/spring/core_01/applicationContextContainer/_08SpringI18n/applicationContext.xml");
